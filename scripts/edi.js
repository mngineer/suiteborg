...
// Description:
//   Hears an EDI number and englishes it.
//
// Dependencies:
//   None
//
...
//
// Commands:
//   hubot edi [edi-number] Who's that EDI document?
//
// Author:
//   Ryan, sourced https://en.wikipedia.org/wiki/X12_Document_List
...
const EDI = {
  ...
  121: "Vehicle Service",
  123: "EASY AS A B C D EDI... FOR US.",
  124: "Vehicle Damage",
  ...
  666: "Request for Soul Acquisition or Payment Contract",
  667: "Response to Request for Soul Acquisition or Payment Contract",
  715: "Intermodal Group Loading Plan",
  753: "Request for Routing Instructions",
  754: "Routing Instructions",
  776: "Luck Event Request",
  777: "Luck Event Request Acknowledgement/Advice",
  ...
  820: "Payment Order/Remittance Advice or Premium Payments",
  ...
  911: "Emergency Services Request (U.S.)",
  912: "Emergency Services Acknowledgement (U.S.)",
...
module.exports = function(robot) {
  robot.respond(/edi (\d\d\d)s?\b/i, function(msg) {
    var ediValue;
    ediValue = EDI[msg.match[1]];
    if (ediValue != null) {
      msg.reply(`${msg.match[1]} IS ${ediValue.toUpperCase()}`);
      return;
    }
    return msg.reply("THAT NUMBER IS IRRELEVANT; EDI HAS NOT ASSIMILATED IT.");
  });
  return robot.respond(/edi (\d*)s?\b/i, function(msg) {
    if (msg.match[1].length !== 3) {
      return msg.reply("DO NOT TOY WITH US; EDI NUMBERS ARE THREE DIGITS.");
    }
  });
};
